...
abstract class ZenValidatorConstraint extends Object
{
    ...
    {
        Requirements::javascript(ZENVALIDATOR_PATH . '/bower_components/parsleyjs/src/extra/validator/' . $name . '.js');

        $lang = i18n::get_lang_from_locale(i18n::get_locale());
        Requirements::javascript(ZENVALIDATOR_PATH . '/bower_components/parsleyjs/src/i18n/' . $lang . '.extra.js');
    }
